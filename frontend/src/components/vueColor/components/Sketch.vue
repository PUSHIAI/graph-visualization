<template>
	...
	>
        <div class="vc-sketch-title">自定义颜色</div>
        <div style="position:relative;">
            <div class="vc-sketch-saturation-wrap">
                <saturation v-model="colors" @change="childChange"></saturation>
            </div>
            <div class="vc-sketch-hue-wrap-new">
		...
		<div class="vc-sketch-field" v-if="!disableFields">
			...
			<div class="vc-sketch-field--double">
				<ed-in label="hex" labelText="RGB" :value="hex" @change="inputChange"></ed-in>
			</div>
...
import editableInput from "./common/EditableInputForSketch.vue";
